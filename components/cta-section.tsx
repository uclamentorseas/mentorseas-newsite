      ...
      <div className="wrap">
        <div className="grid grid-cols-12 gap-x-6 md:gap-x-10">
          <div className="col-span-12 md:col-span-3">
            ...
            <div className="serif text-7xl md:text-8xl leading-none tabular text-ink/80">06</div>
          ...
          <div className="col-span-12 md:col-span-9 md:col-start-4">
            ...
            <h2 className="serif text-[12vw] md:text-[6.4vw] xl:text-[5.4vw] leading-[0.98] tracking-[-0.022em] text-ink max-w-[20ch]">
              ...
              <br />
              <span className="serif-italic">from someone who was in your shoes</span>
              <br />
              a year ago<span className="text-accent">.</span>
            </h2>
